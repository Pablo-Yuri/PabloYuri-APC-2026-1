...
# def carregar_arquivo(candidates):
...
# path = BASE_DIR / carregar_arquivo(MORADORES_FILES)
# df = :
# print(pd.read_csv(path, sep=";", decimal=",", encoding="utf-8-sig"))
