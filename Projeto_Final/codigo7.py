...
from recorte_c.dados import garantir_colunas_numericas, selecionar_colunas_exibicao
...
class AplicativoRecorteC:
    ...
    def _montar_estilo(self) -> None:
        ...
        style.configure("Stat.TLabelframe.Label", font=("Segoe UI", 10, "bold"))
    ...
    def _atualizar_previa_tabela(self) -> None:
        ...
        previa = selecionar_colunas_exibicao(self.dados_filtrados, limite=200)
        if previa.empty:
            return
    ...
    def exportar_csv(self) -> None:
        ...
        previa = selecionar_colunas_exibicao(self.dados_filtrados, limite=len(self.dados_filtrados))
