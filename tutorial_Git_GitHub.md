...
**Disciplina:** Computação Para Engenharia — CPE 2026/1
...
echo "# Meu Portfólio — CPE 2026/1" > README.md
...
# Substitua "usuario" e "CPE-2026-1" pelos seus dados reais
git remote add origin https://github.com/usuario/CPE-2026-1.git
...
git clone https://github.com/usuario/CPE-2026-1.git
...
# 3. Adicionar arquivos específicos à staging area -> Exemplo
git add projeto/calculadora.cpp
...
git blame projeto/calculadora.cpp
```
...
# 2. Configure o Git para salvar as credenciaistutorial_Git_GitHub
git config --global credential.helper store
...
git remote set-url origin git@github.com:usuario/CPE-2026-1.git
```
...
git remote set-url origin git@github-unb:usuario_unb/CPE-2026-1.git
...
- Salve — em alguns minutos sua página estará em:
  `https://usuario.github.io/CPE-2026-1/`
